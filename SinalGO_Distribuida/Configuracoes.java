package projects.SimuladorRSSF;

/*
 * Classe que implementa diversos parametros de configuração
 * necessários para execução da simulação
 */
public final class Configuracoes {
	
	//porcentagem do pacote ser entregue, a cada envio de um nó para outro
