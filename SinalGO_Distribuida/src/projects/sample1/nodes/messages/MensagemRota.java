...
//classe que implementa a mensagem de roteamento
public class MensagemRota extends Message{

	//possibilita a partir deste atributo verificar a distancia do n� ao sink
	...
	//verifica se a mensagem contem o mesmo id, se � da mesma rodada de roteamento e se � do mesmo sink
	@Override
	...
	//verifica se a mensagem contem o mesmo id e se � da mesma rodada de roteamento, independente do sinks
